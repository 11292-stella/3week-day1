...
const piuStringhe = function (str1, str2) {
  let primeDue = str1.slice(0, 2)
  let ultimeTre = str2.slice(-3)
  let risultato = primeDue + ultimeTre
  console.log(risultato)
}

piuStringhe(`ciaone`, `burrone`)
